USE [master]
GO
/****** Object:  Database [DietCScharp]    Script Date: 22/01/2021 20:47:16 ******/
...
USE [DietCScharp]
GO
/****** Object:  Table [dbo].[DiasdaSemana]    Script Date: 22/01/2021 20:47:16 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Dieta]    Script Date: 22/01/2021 20:47:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Perfil]    Script Date: 22/01/2021 20:47:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PorcaoDeAlimento]    Script Date: 22/01/2021 20:47:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PorcaoDeAlimentoDiasdaSemana]    Script Date: 22/01/2021 20:47:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PorcaoDeAlimentoDieta]    Script Date: 22/01/2021 20:47:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Refeicoes]    Script Date: 22/01/2021 20:47:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RefeicoesPorcaoDeAlimento]    Script Date: 22/01/2021 20:47:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[RefeicoesPorcaoDeAlimento](
...
GO
/****** Object:  Table [dbo].[Usuario]    Script Date: 22/01/2021 20:47:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
REFERENCES [dbo].[DiasdaSemana] ([ID])
GO
...
GO
ALTER TABLE [dbo].[RefeicoesPorcaoDeAlimento]  WITH CHECK ADD  CONSTRAINT [FK_Rel_Ref_Porc_PorcaoDeAlimento] FOREIGN KEY([ID_PorcAlimento])
REFERENCES [dbo].[PorcaoDeAlimento] ([ID])
GO
ALTER TABLE [dbo].[RefeicoesPorcaoDeAlimento] CHECK CONSTRAINT [FK_Rel_Ref_Porc_PorcaoDeAlimento]
GO
ALTER TABLE [dbo].[RefeicoesPorcaoDeAlimento]  WITH CHECK ADD  CONSTRAINT [FK_Rel_Ref_Porc_Refeicoes] FOREIGN KEY([ID_Refeicao])
REFERENCES [dbo].[Refeicoes] ([ID])
GO
ALTER TABLE [dbo].[RefeicoesPorcaoDeAlimento] CHECK CONSTRAINT [FK_Rel_Ref_Porc_Refeicoes]
GO
